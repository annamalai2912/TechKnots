...
const ContactSection = () => {
  ...
  const handleWhatsApp = () => {
    window.open(
      'https://wa.me/+919176747268?text=Hello%2C%20I%20would%20like%20to%20contact%20you.',
      '_blank'
    );
  };
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                <div
                  ...
                  onClick={() => navigator.clipboard.writeText('+91 9176747268')}
                >
              ...
              <div className="flex items-center space-x-4">
                <div
                  className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center cursor-pointer"
                  onClick={() => window.open('mailto:techknotsofficial@gmail.com', '_blank')}
                >
              ...
              <div className="flex items-center space-x-4">
                <div
                  ...
                  onClick={() =>
                    window.open(
                      'https://www.google.com/maps?q=13.035170,80.220760',
                      '_blank'
                    )
                  }
                >
                ...
                <div>
                  ...
                  >
                    No: 6/26, Karunanidhi 2nd street, West Mambalam, Chennai - 600033
                  </p>
                </div>
              </div>
